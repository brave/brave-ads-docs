...
| CPA                         | O custo por ação encontrado dividindo o custo total da campanha pelo número de conversões.                                                                                                                                                                                                                                                                   | X                    |                       | X                            | X                       |   |
...
### Parâmetros de string de consulta e cookies de primeira parte (Por exemplo, UTMs) UTMs) UTMs)
