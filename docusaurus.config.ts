  ...
  headTags: [
    {
      ...
      attributes: {
        ...
        content: `default-src 'none'; img-src 'self' data:; script-src 'self' 'unsafe-inline' 'unsafe-eval'; style-src 'self' 'unsafe-inline'; font-src 'self' data:; base-uri 'none'; form-action 'none'; object-src 'none'; media-src 'none'; frame-src  https://*.ads.s.brave.io; connect-src https://*.algolia.net https://*.algolianet.com https://*.algolia.io;`,
      },
    }
  ],
