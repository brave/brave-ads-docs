...
### Available metrics in Brave Ads Manager reporting
|   |   |   |   |   |   |
|---|---|---|---|---|---|
|**Metric**|**Description**|**Search keyword Ads**|**New Tab Takeover**|**Newsfeed Ads**|N**otification Ads**|
...
Take, for example, the following Conversion Page URL: https://example.com/checkout?order=ABC-12345-xyz. Brave will look for the query string key order and encrypt the value ABC-12345-xyz. DOM Element Pattern An advertiser has a Conversion ID that is present in the Document Object Model (DOM) of the Conversion Page URL.
