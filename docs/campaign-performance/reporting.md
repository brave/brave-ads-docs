...
- Conversion page URLs **must** follow these conditions in order to be approved:
	- Be on the same eTLD+1 as the email domain used
		- For example, if my email address is [admin@example.com](mailto:admin@flower.com), I can set the conversion URL as a page on [https://example.com](https://flower.com) or a sub-domain of that website, such as [https://shop.example.com](https://shop.flower.com).
